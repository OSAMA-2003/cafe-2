...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "peer group/switch relative inline-flex shrink-0 items-center rounded-full border border-zinc-300/30 transition-all outline-none focus-visible:ring-2 focus-visible:ring-[#775a19]/50 data-[size=default]:h-6 data-[size=default]:w-11 data-[size=sm]:h-5 data-[size=sm]:w-9 data-checked:bg-emerald-500 data-unchecked:bg-zinc-300 pl-0.5 rtl:pr-0.5 data-disabled:cursor-not-allowed data-disabled:opacity-50 shadow-inner",
        className
      )}
      {...props}
    >
